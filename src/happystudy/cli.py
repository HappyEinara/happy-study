...
import happystudy as package
from happystudy import log, pingpong, settings
...
def version_callback(output_version: bool = False) -> None:
    ...
    if output_version:
        typer.echo(f"Happy Study v{version}")
...
def callback(
    ...
    if log_dir:
        ...
        log_path = settings.log_dir / "happystudy.log.txt"
